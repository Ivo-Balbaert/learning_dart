...
class Tabs extends WebComponent {
  ...
  get _root => getShadowRoot("x-tabs");
  ...
  void created_autogenerated() {
    var __root = createShadowRoot("x-tabs");
    setScopedCss("x-tabs", new autogenerated.ScopedCssMapper({"x-tabs":"[is=\"x-tabs\"]"}));
    _css = getScopedCss("x-tabs");
    __t = new autogenerated.Template(__root);
    __root.nodes.add(__shadowTemplate.clone(true));
    __e1 = __root.nodes[3];
    __t.component(new Swap()..host = __e1);
    __t.create();
  }
